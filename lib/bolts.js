...
function generateProject(opts, callback) {
	...
	fs.renameSync(path.join(dest, 'lib', 'module.sln'), path.join(dest, 'lib', opts.project + '.sln'));
	fs.renameSync(path.join(dest, 'lib', 'module.njsproj'), path.join(dest, 'lib', opts.project + '.njsproj'));
